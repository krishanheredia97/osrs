...
class SuperheatBot:
    ...
    async def bot_loop(self):
        ...
        if not orange_coords or not blue_coords or not green_coords:
        ...
        for _ in range(3):
            ...
            await self.perform_action(orange_coords, "Getting seaweed")
        ...
        # Get sand
        await self.perform_action(blue_coords, "Getting sand")
        await asyncio.sleep(0.4)
